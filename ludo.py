# Ludo game : NISCHITH URS [01JST19PMC029] SUHAS M R[01JST19PMC041] #
from tkinter import *
...
class Ludo:
    ...
    def board_set_up(self):
        ...
        self.make_canvas.create_rectangle(340+(40*3), (15+240)+(40*3), 340+(40*3)+(40*6), (15+240)+(40*3)+(40*6), width=3, fill="yellow")# right down YELLOw square
        ...
        def operate(ind):
            if ind:
                ...
                def delay_with_instrctions(time_is):
                    ...
                    if time_is > 5:
                        command_play['text'] = f"             COmputer Play With Red and You Play With Sky Blue"
                    elif time_is>= 2 and time_is<5:
                        command_play['text'] = f"                       You Will Get the First Chance to play"
                    else: 
                        command_play['text'] = f"                                        Lets starrt & enjoy the Game"
